...
def ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if not user_id:
        message.reply_text("User nhi mil rha.")
        return ""
    ...
    if user_id == bot.id:
        message.reply_text("Me gali nhi deta par mera Bapu deta h @m_Anti_korona usko bol wo ban karega mujko ?")
        return ""
    ...
    try:
        ...
        keyboard = []
        reply = "{} Nikl!".format(mention_html(member.user.id, member.user.first_name))
        ...
        if excp.message == "Reply message not found":
            # Do not reply
            message.reply_text('Nikl!', quote=False)
            return log
        else:
...
def temp_ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if not user_id:
        message.reply_text("Kaha gya wo?.")
        return ""
...
def kick(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if is_user_ban_protected(chat, user_id):
        message.reply_text("CHuppppp!! Wo admin h ..")
        return ""

    if user_id == bot.id:
        message.reply_text("Me gali nhi deta par mera Bapu deta h @m_Anti_korona usko bol wo kick karega mujko ?")
        return ""
...
def kickme(bot: Bot, update: Update):
    ...
    if is_user_admin(update.effective_chat, user_id):
        update.effective_message.reply_text("Mere bhai tuje laat marni thi but tu admin h yaar!!!!")
        return
...
def unban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("Bot h ye to Niklll!!!!!!...")
        return ""

    if is_user_in_chat(chat, user_id):
        message.reply_text("Aila Jadu!!ye user ban nhi hua tha")
        return ""
